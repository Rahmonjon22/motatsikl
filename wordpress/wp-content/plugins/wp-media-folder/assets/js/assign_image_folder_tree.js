    ...
    wpmfAssignModule = {
        ...
        genFormassigntree: function () {
            ...
            if (typeof wpmfFoldersModule.categories[wpmfFoldersModule.last_selected_folder].drive_type !== "undefined" && wpmfFoldersModule.categories[wpmfFoldersModule.last_selected_folder].drive_type !== "") {
                ...
                return '<div class="wpmfjaoassign_row"><div class="wpmfjaoassign_left"></div><div class="wpmfjaoassign_right"><a class="open-popup-tree"><span class="material-icons-outlined"> snippet_folder </span>' + wpmf.l18n.assign_tree_label + '</a></div></div>';
            }
        }
    };
