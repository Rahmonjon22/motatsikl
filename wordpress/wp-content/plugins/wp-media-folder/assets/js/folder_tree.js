...
(function ($) {
    wpmfFoldersTreeModule = {
        ...
        getRendering: function getRendering() {
            ...
            content = '<a class="wpmf-new-folder" onclick="wpmfFoldersModule.newFolder(wpmfFoldersModule.last_selected_folder)"><i class="material-icons">add</i>' + wpmf.l18n.create_folder + '</a>' + search_folder + content + loadmore + search_no_result;
