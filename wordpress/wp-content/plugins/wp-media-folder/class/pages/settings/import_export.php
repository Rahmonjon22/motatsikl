    ...
    <div class="tab-content">
        ...
        <div class="content-box">
            <div class="ju-settings-option wpmf_width_100 p-d-20">
                ...
                <p>
                    <button type="button"
                            class="ju-button no-background orange-button waves-effect waves-light open_import_eml"
                            style="margin-left: 0 !important;"><?php esc_html_e('Import Now', 'wpmf'); ?></button>
                </p>
            </div>
        </div>
    </div>
...
<?php
if (is_plugin_active('real-media-library-lite/index.php') || is_plugin_active('real-media-library/index.php')) :
    $total = $wpdb->get_var('SELECT COUNT(id) as total FROM ' . $wpdb->prefix . 'realmedialibrary');
    if ($total > 0) :
        ?>
        <div class="tab-content">
            <div class="wpmf_width_100 top_bar">
                <h1><?php echo esc_html__('Import Real Media Library', 'wpmf') ?></h1>
            </div>
            <div class="content-box">
                <div class="ju-settings-option wpmf_width_100 p-d-20">
                    <p class="description">
                        <?php esc_html_e('Import current media Real Media Library categories as media folders', 'wpmf'); ?>
                    </p>
                    <p>
                        <button type="button"
                                class="ju-button no-background orange-button waves-effect waves-light wmpf_import_rml"
                                style="padding: 8.5px 15px">
